...
typedef enum GX_STATUS_LIST
{
	...
	GX_STATUS_ERROR              = -1001,        ///< 失败
	GX_STATUS_NO_DATA            = -1002,        ///< 没有数据
	GX_STATUS_INVALID_HANDLE     = -1003,        ///< 非法句柄
	GX_STATUS_INVALID_PARAMETER  = -1004,        ///< 参数非法
	GX_STATUS_OUT_RANGE          = -1005,        ///< 越界错误
	GX_STATUS_RUNTIME_ERROR      = -1006,        ///< 运行时错误
	GX_STATUS_LOGIC_ERROR        = -1007,        ///< 逻辑错误
	GX_STATUS_TIMEOUT_ERROR      = -1008,        ///< 超时错误
	GX_STATUS_DYNAMIC_CAST_ERROR = -1009,        ///< 动态类型转换错误
	GX_STATUS_GENCIAM_ERROR      = -1010,        ///< GenICam调用相关
}GX_STATUS_LIST;
...
typedef enum GX_FEATURE_ID
{
	...
	GX_STRING_FACTORY_SETTING_VERSION = 6 | GX_FEATURE_STRING,     ///< 出厂参数版本
	...
	GX_ENUM_TRIGGER_SOURCE            = 3013 | GX_FEATURE_ENUM,    ///< 触发源,参考GX_TRIGGER_SOURCE_ENTRY
	GX_ENUM_EXPOSURE_MODE             = 3014 | GX_FEATURE_ENUM,    ///< 曝光模式，参考GX_EXPOSURE_MODE_ENTRY
	...
	GX_INT_CONTRASTPARAM              = 6017 | GX_FEATURE_INT,    ///< 对比度参数
	GX_FLOAT_GAMMAPARAM               = 6018 | GX_FEATURE_FLOAT,  ///< 伽马参数
	GX_INT_COLORCORRECTIONPARAM       = 6019 | GX_FEATURE_INT,    ///< 颜色校正参数
	GX_ENUM_IMAGE_GRAY_RAISE_SWITCH   = 6020 | GX_FEATURE_ENUM,   ///< 图像亮度拉伸开关,参考GX_IMAGE_GRAY_RAISE_SWITCH_ENTRY
	GX_ENUM_AWB_LAMP_HOUSE            = 6021 | GX_FEATURE_ENUM,   ///< 自动白平衡光照环境,参考GX_AWB_LAMP_HOUSE_ENTRY
...
typedef enum GX_AWB_LAMP_HOUSE_ENTRY
{
	...
	GX_AWB_LAMP_HOUSE_D65           = 1,                      ///< 指定D65光源
